        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-4 px-4">
            ...
            <div className="relative mt-24">
                <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                    <div className="z-20 w-12 h-12 bg-[#38BDF8] rounded-full flex justify-center items-center">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="#38BDF8" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                <div>
                    <p className="font-semibold lg:text-2xl text-lg lg:leading-6 leading-5 text-gray-800 mt-6">Risk Management</p>
                    <p className="font-normal lg:text-base text-sm leading-6 text-gray-600 mt-6">Less than 1.5% of capital is risked on every execution in the sense that the finacial market is a risky environment, and the firm understands.</p>
                </div>
                <div>
                    <p className="font-semibold lg:text-2xl text-lg lg:leading-6 leading-5 text-gray-800 mt-6">High Accuracy and Consistency</p>
                    <p className="font-normal lg:text-base text-sm leading-6 text-gray-600 mt-6">World Class Forex works with a group of professional financial traders with over 10 years of trading experience who see to it that profits are generated continuosly.</p>
                </div>
                <div className="sm:block hidden">
                    <p className="font-semibold lg:text-2xl text-lg lg:leading-6 leading-5 text-gray-800 mt-6">Transparency</p>
                    <p className="font-normal lg:text-base text-sm leading-6 text-gray-600 mt-6">The firm shares trade history with clients from time to time keep them updated.</p>
                </div>
            </div>
            ...
            <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
                <div className="w-full lg:w-6/12">
                    ...
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">To be a trading firm that seeks to help individuals through professional forex trading.</p>
                    <div className="py-10">
                        <hr />
                    </div>
                    <h2 className="font-bold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 mt-8">Our Mission</h2>
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">The firm gives equal or same opportunities to all kind of people to succeed in finacial trading through the provision of appropriate learning materials.</p>
                </div>
                <div className="w-full lg:w-6/12">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
                        {/* <!-- Team Card --> */}
                        <div className="flex p-4 shadow-md bg-sky-300 rounded-xl">
                            <div className="mr-6">
                            ...
                            <div className="">
                                <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800">Deposit</p>
                        ...
                        {/* <!-- Board Card --> */}
                        <div className="flex p-4 shadow-md bg-cyan-300 rounded-xl">
                            <div className="text-gray-600 mr-6">
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-wallet" width={36} height={36} viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <div className="">
                                <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800">Withdrawal</p>
                                <p className="mt-2 font-normal text-base leading-6 text-gray-600">Midweek withdrawal (Wednesdays) opens at 12:00AM GMT and closes at 2:00PM GMT. Weekend withdrawal (Saturday and Sundays) opens at 12:00AM and closes at 6:00PM GMT.</p>
                            </div>
                        </div>

                        {/* <!-- Press Card --> */}
                        <div className="flex p-4 shadow-md bg-teal-300 rounded-xl">
                            <div className="mr-6">
                            ...
                            <div className="">
                                <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800">Customer Service</p>
                                <p className="mt-2 font-normal text-base leading-6 text-gray-600">Contact us any time within 6:00AM and 8:00PM on weekdays, and 8:00AM and 6:00PM on weekends.</p>
                            </div>
                        </div>
                    </div>
                </div>
