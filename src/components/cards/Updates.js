        ...
        <div>
            <section className="p-6 my-6 text-gray-100">
                <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
                    <div className="flex p-4 space-x-4 shadow-md rounded-md md:space-x-6 bg-gray-50 text-gray-600">
                        <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-red-400">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="h-9 w-9 text-gray-50">
                    ...
                    <div className="flex p-4 space-x-4 rounded-md shadow-md md:space-x-6 bg-gray-50 text-gray-600">
                        <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-emerald-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="h-9 w-9 text-gray-50">
                    ...
                    <div className="flex p-4 space-x-4 rounded-md shadow-md md:space-x-6 bg-gray-50 text-gray-600">
                        <div className="flex justify-center p-2 align-middle rounded-md sm:p-4 bg-cyan-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="h-9 w-9 text-gray-50">
