            ...
            <div className="relative w-full bg-slate-800">
                <div>
                    <div className="container px-8 md:px-12 xl:max-w-5xl mx-auto lg:px-7 xl:px-0">
                        <div className="md:flex md:gap-12 pt-40 lg:pb-16 lg:pt-[11rem]">
                            <div className="md:w-6/12">
                                <h1 className="text-gray-50 font-bold text-4xl xl:text-5xl">Build in your way but with our expert <span className="text-sky-500">Support.</span></h1>
                                <p className="mt-8 text-gray-50"><em>World Class Forex Institute</em> is a financial trading firm that helps individuals to gain daily interests on their investments through professional trading.</p>
