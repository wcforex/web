                        ...
                        <div className="px-6 w-full flex flex-wrap items-center justify-between">
                            ...
                            <div className="navbar-collapse collapse grow items-center" id="navbarSupportedContentY">
                                <ul className="navbar-nav mr-auto lg:flex lg:flex-row">
                                    ...
                                    <li className="nav-item">
                                        <a className="nav-link block pr-2 lg:px-2 py-2 text-gray-600 hover:text-gray-700 focus:text-gray-700 transition duration-150 ease-in-out" href="/" data-mdb-ripple="true" data-mdb-ripple-color="light">Community Forum</a>
                                    </li>
                                    ...
                                    <li className="nav-item">
                                        <a className="nav-link block pr-2 lg:px-2 py-2 text-gray-600 hover:text-gray-700 focus:text-gray-700 transition duration-150 ease-in-out" href="/" data-mdb-ripple="true" data-mdb-ripple-color="light">Wallet</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link block pr-2 lg:px-2 py-2 text-gray-600 hover:text-gray-700 focus:text-gray-700 transition duration-150 ease-in-out" href="/" data-mdb-ripple="true" data-mdb-ripple-color="light">Documents</a>
                                    </li>
                                    <li className="nav-item mb-2 lg:mb-0">
                        ...
                        <div className="container mx-auto xl:px-32 text-gray-800">
                            <div className="grid lg:grid-cols-2 gap-12 flex items-center">
                                <div className="mt-12 lg:mt-0" style={{ zIndex: "10" }}>
                                    <h1 className="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12" style={{ color: "hsl(218, 81%, 95%)" }}>MyCRM.AI <br /><span style={{ color: "hsl(218, 81%, 75%)" }}>Coming Soon</span></h1>
                                    <p className="opacity-70" style={{ color: "hsl(218, 81%, 85%)" }}>
                                        Staying connected should not mean sacrificing your data and privacy to big tech companies for corparate greed and amnipulation. Web 3.0 allows us the ability to not only take control of our data but, but to truly own our interlectual property. We invite you to join our community in taking the next steps in decentralized grassroots community building.
                                    </p>
                                </div>
                                    ...
                                    <div className="block rounded-lg shadow-lg bg-glass px-6 py-12 md:px-12">
                                        <form>
                                            ...
                                            <div className="flex justify-center">
                                                <a href="/" role="button" className="text-blue-600 hover:text-blue-700 focus:text-blue-700 action:text-blue-800 transition duration-200 ease-in-out">
