...
import { allPackages } from "../containers/store/actions/packageActions"
...
const Pricing = () => {
  ...
  const getAllPackages = useSelector((state) => state.getAllPackages)
  const { loading, packages, error } = getAllPackages;
  console.log(packages)

  const getData = () => {
    setLoader(true)
    dispatch(allPackages)
    if (loading === false && packages) {
      console.log(packages)
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center">
                  ...
                  <p className="font-medium text-gray-800">30% return per day</p>
                </li>
                <li className="flex items-center">
                  <div className="mr-2">
                    <svg
                  ...
                  <p className="font-medium text-gray-800">150% total return</p>
                </li>
              </ul>
            </div>
          </div>
